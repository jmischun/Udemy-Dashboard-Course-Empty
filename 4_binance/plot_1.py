...
table_trace = go.Table(
	...
	cells=dict(values=[binance_price().index[:], binance_price()['open'], binance_price()['high'], binance_price()['low'], binance_price()['close'], binance_price()['volume'], binance_price()['num_trades']],
...
# Create plot and html
fig = dict(data=[table_trace, trace, trace_2, trace_3], layout=layout)
