...
function LogConsoleStatusComponent(props) {
    return (React.createElement(GroupItem, { spacing: 0, onClick: props.handleClick, title: `${props.messages} messages in current log` },
        React.createElement(DefaultIconReact, { name: 'list', top: '2px', kind: 'statusBar' }),
        React.createElement(TextItem, { source: props.messages })));
}
/**
...
export class LogConsoleStatus extends VDomRenderer {
    ...
    render() {
        ...
        this.show();
        let { flashEnabled, messages, source, version, versionDisplayed, versionNotified } = this.model;
        ...
        return (React.createElement(LogConsoleStatusComponent, { handleClick: this._handleClick, messages: messages }));
    }
    _flashHighlight() {
        this._showHighlighted();
