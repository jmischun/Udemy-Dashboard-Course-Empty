...
function main() {
  ...
  try {
    ...
    if (isDisabled('@jupyterlab/plotly-extension')) {
      ...
      extMod = require('@jupyterlab/plotly-extension/');
      extension = extMod.default;
  ...
  try {
    ...
    if (isDisabled('jupyterlab-plotly')) {
      disabled.matches.push('jupyterlab-plotly');
    } else {
      extMod = require('jupyterlab-plotly/dist/javascript-renderer-extension.js');
      extension = extMod.default;
  ...
  try {
    ...
    if (isDisabled('plotlywidget')) {
      ...
      extMod = require('plotlywidget/src/jupyterlab-plugin.js');
      extension = extMod.default;
